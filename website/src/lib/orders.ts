...
export const validSources: OrderSource[] = ["External", "Manual", "Imported"];
export const validStatuses: OrderStatus[] = ["Available", "Draft", "Imported"];
...
export function validateItems(value: unknown): OrderItem[] {
